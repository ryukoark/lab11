        ...
        <form method="POST" action="{{ route('contacts.update', $contact) }}">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input type="text" name="email" type="email" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ old('email', $contact->email) }}">
